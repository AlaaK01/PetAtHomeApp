...
export default function BirdForm(props) {
  const { bird, overrides, ...rest } = props;
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "BirdForm")}
      {...rest}
    >
      <Flex
        gap="20px"
      ...
      >
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIcon36492918")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            {...getOverrideProps(overrides, "MyIcon36492919")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            padding="0px 0px 0px 0px"
            type="send"
            {...getOverrideProps(overrides, "MyIcon36492920")}
          ></MyIcon>
        </Flex>
        <Flex
          gap="10px"
