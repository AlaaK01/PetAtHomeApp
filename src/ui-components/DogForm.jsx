...
export default function DogForm(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "DogForm")}
      {...rest}
    >
      <Flex
        gap="20px"
      ...
      >
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIcon36492854")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            {...getOverrideProps(overrides, "MyIcon36492855")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            padding="0px 0px 0px 0px"
            type="send"
            {...getOverrideProps(overrides, "MyIcon36492856")}
          ></MyIcon>
        </Flex>
        <Flex
          gap="10px"
